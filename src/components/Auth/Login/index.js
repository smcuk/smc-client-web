        ...
        <div style={styles.boxContainer}>
          ...
          <div style={styles.buttonsDiv}>
            ...
            <div className="signup-container">
              <button className="signup-button signup-button-facebook" onClick={this.props.onSignInFacebook}>
              ...
              <button className="signup-button signup-button-twitter" onClick={this.props.onSignInTwitter}>
                <span className="signup-icon-svg">
